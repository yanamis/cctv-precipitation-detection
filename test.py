...
# Wczytanie modelu
model = load_model('plots_model_arch_3_median_5_30epochs/model_arch_3_median_5_30epochs.h5')
...
excel_path = "all_images_info_model_arch_3_median_5_30epochs_new_data.xlsx"
